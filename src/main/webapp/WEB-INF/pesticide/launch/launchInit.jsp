    ...
    <div id="search_box" class="row">
        <div class="mb_15 col-md-4">
            <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd"
                ...
                <input class="form-control" size="16" type="text" id="beginDate" name="beginDate" readonly placeholder="开始时间">
        ...
        <div class="mb_15 col-md-4">
            <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd"
                ...
                <input class="form-control" size="16" type="text" id="endDate" name="endDate" readonly placeholder="结束时间">
                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
            </div>
