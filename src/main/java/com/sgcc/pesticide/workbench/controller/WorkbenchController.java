...
public class WorkbenchController {
    ...
    public @ResponseBody
    Map<String, Object> getIssueList(@RequestBody Map<String, String> param) {
        Date now = new Date();
    ...
    @RequestMapping("/push")
    public @ResponseBody
    String push(@RequestBody Map<String, String> param) {
    ...
    public @ResponseBody
    String changePrincipal(@RequestBody Map<String, String> param) {
    ...
    public @ResponseBody
    String reject(@RequestBody Map<String, String> param) {
    ...
    public @ResponseBody
    String changeStateWithReason(@RequestBody Map<String, String> param) {
        boolean result = workbenchService.updateState(param);
        if (result) {
    ...
    public @ResponseBody
    String changeState(String businessId, String issueType, String state) {
    ...
    public @ResponseBody
    String submitRemark(String uuid, String remark) {
        try {
